<p align="center"><a href="https://theworldavatar.io" target="_blank" rel="noopener noreferrer"><img width="100%" src="../media/twa-readme-header.png" alt="The World Avatar logo"></a></p>
...
**TWA Base Library:**<br/>
The [base lib](https://github.com/TheWorldAvatar/baselib) is a collection of functionality that is shared among many parts of the code. Core functions include the ability to generate and upload TBoxes, query KGs and RDBs, implement RESTful APIs, and triple cloning.

**TWA Visualisation Framework:**<br/>
The [TWA-VF](https://github.com/TheWorldAvatar/viz) is a container that provides a web-page with which a user can view and explore geospatial information held in the TWA ecosystem. This includes not only map data, 3D-representations of buildings, and building information models (BIM), but also any data or information connected to them within the KG, such as data calculated by models, acquired sensor data, or other time series data.

**TWA Ontologies:**<br/>
The [ontology library](https://github.com/TheWorldAvatar/ontology) lists mid- to lower-level formal ontologies that were developed for certain use cases within TWA. The TWA framework accommodates existing ontologies and extends them where necessary to allow a more complete description of relevant concepts.

**Autonomous Agents:**<br/>
Agents are pieces of software that act on the knowledge graph - reading from it, writing to it, thus making it evolve dynamically in time. The agents live in different repositories that are specific to the topic or project they were developed for (e.g., the [Exposure Calculation Agent](https://github.com/TheWorldAvatar/exposure-calculation-agent)). There also exists an [agent template](https://github.com/TheWorldAvatar/Agent-Template-java) for Java developers. Some agents can still be found in the old repository's [agents folder](https://github.com/cambridge-cares/TheWorldAvatar/tree/main/Agents).

**Object Graph Mapper:**<br/>
The main purpose of the OGM is to provide a layer of abstraction so that developers can write code that interacts with the KG without having to write queries or updates in a query language such as SPARQL. An OGM achieves this by mapping concepts and their properties as represented in the KG to classes with member fields in an object-oriented programming language. A developer can then simply write their code using classes and objects like they would write any other code. The [twa package](https://cambridge-cares.github.io/TheWorldAvatar/) provides this functionality for Python development.
...
* Key Collaborators:
  * [CoMo](https://como.ceb.cam.ac.uk/), [CMCL](https://www.cmcl.io/), [CMPG](https://www.cmpg.io/)